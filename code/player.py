...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, *groups, collision_sprites):
        ...
        self.hitbox_rect = self.rect.inflate(-60, -90) #used for proper collisions
    ...
    def input(self):
        ...
        self.direction.y = int(keys[pygame.K_DOWN] or keys[pygame.K_s]) - int(keys[pygame.K_UP] or keys[pygame.K_w]) # same as above
    ...
    def collision(self, direction):
        #collision logic relies on checking the direction of the player movement and if they overlap with
        #an obstacle moving them to the side of the obstacle
